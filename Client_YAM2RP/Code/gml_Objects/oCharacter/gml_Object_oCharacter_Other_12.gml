...
if (invincible == 0)
{
    ...
    {
        if (otherOBJ == 439 && other.ibeam && (!global.freezeDisabled || (global.exp_chargefreezesvaria && other.chargebeam)) && global.playerFreeze == 0 && invincible == 0 && canbehit && state != IDLE && state != SAVING && state != SAVINGFX && state != SAVINGSHIPFX && state != SAVINGSHIP && state != ELEVATOR && state != GFELEVATOR)
        {
        ...
        if ((otherOBJ == 440 || otherOBJ == 438) && other.icemissiles && !other.smissile && (!global.freezeDisabled || global.exp_chargefreezesvaria) && global.playerFreeze == 0 && invincible == 0 && canbehit && state != IDLE && state != SAVING && state != SAVINGFX && state != SAVINGSHIPFX && state != SAVINGSHIP && state != ELEVATOR && state != GFELEVATOR)
        {
